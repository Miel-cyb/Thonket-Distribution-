...
function MainPage(){
    ...
    return(
        <>
            ...
            <Layout image="/customer.png" title="Customer" desc="Customers are the backbone of any distribution company. To build trust and satisfaction, the company: 
            ...
            <Layout image="/driver.jpg" title="Drivers" desc="Drivers play a crucial role in ensuring smooth distribution. A strong relationship with them enhances efficiency: Proper Training & Support – Well-trained drivers understand safety, efficiency, and customer service. Fair Compensation & Incentives – Bonuses for performance and fuel allowances keep drivers motivated.
            Advanced Route Planning – GPS tracking and optimized routes reduce stress and improve delivery times." box ={true} />

            <Layout image="/partners.png" title="Partners" desc="We rely on strong partnerships with suppliers, manufacturers, and retailers. Effective collaboration is key to a smooth supply chain:
